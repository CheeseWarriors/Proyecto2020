...
namespace PROYECTO_GUERRA
{
    public class Consultas
    {
        ...
        public Consultas()
        {
            ...
            this.iPservidor = utilesXML.LeerConfig(archivoConfig, "IP");
            this.bdd = utilesXML.LeerConfig(archivoConfig, "BasedeDatos");
            this.usuarioBD = utilesXML.LeerConfig(archivoConfig, "UsuarioMySQL");
            this.contraseniaBD = utilesXML.LeerConfig(archivoConfig, "Contraseña");
            ...
            (string usuarioCi, string usuario, string hash, string sal)
        {
            ...
            string consulta = "INSERT INTO " + bdd + ".usuario(U_ID,U_Nombre,U_Sal,U_Hash) " +
